...
const Calculator = {
    //This will display 0 on the calulator screen
    Display_Value: '0',
    //This will hold the first operand for any expressions, we set it null for now
    First_Operand: null,
    //This checks wether or not the second operand has been inputterd by the user
...
function Input_Decimal(dot) {
    //This ensures that accidental clicking of the deciaml point doesn't cause bugs in operation
...
function Handle_Operator(Next_Operator) {
    ...
    //When an operator key iss pressed we convert the current number display on the screen to a number and then store the results in
    //Caluclator.First_Operand if it doesn't already exist
...
Update_Display();
//This section monitors buttons clicks
